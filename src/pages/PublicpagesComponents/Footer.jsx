  ...
  return (
    <footer className="py-3 ">
      <ul className="nav justify-content-center border-bottom pb-3 mb-3">
        ...
        <li className="nav-item">
          <a href="/city-categories" className="nn nav-link px-2 text-body-secondary">Explore</a>
        </li>
        <li className="nav-item">
          <a href="/user-post" className="nn nav-link px-2 text-body-secondary">Share</a>
        </li>
      </ul>
      ...
      <p className="text-center mt-1">
        ...
        >
          <span className="text-primary me-2">Hedi Shawqi</span>
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-envelope email-icon" viewBox="0 0 16 16">
